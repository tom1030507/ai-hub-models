...
def get_cached_asset(part: int, device_name: str = "snapdragon_8_elite") -> str:
    # Map device names to asset paths
    device_map = {
        "Snapdragon 8 Elite QRD": "snapdragon_8_elite",
        "Snapdragon X Elite CRD": "snapdragon_x_elite", 
        "Samsung Galaxy S24": "snapdragon_8_gen_3"
    }
    
    # Use device name if provided, otherwise default to snapdragon_8_elite
    asset_device = device_map.get(device_name, "snapdragon_8_elite")
    
    model_path = CachedWebModelAsset.from_asset_store(
        MODEL_ID, MODEL_ASSET_VERSION, f"{asset_device}/models.zip"
    ).fetch(extract=True)
...
class PromptProcessor_Part1(BasePrecompiledModel):
    """
    Prompt Processor Part1 for Phi-3.5-mini-instruct.

    Pre-trained, quantized (w4a16 + w8a16 weight, float32 activations)
    and compiled into serialized binary for Qualcomm devices.
    """

    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> PromptProcessor_Part1:
        return PromptProcessor_Part1(get_cached_asset(part=1, device_name=device_name))
...
class PromptProcessor_Part2(BasePrecompiledModel):
    """
    Prompt Processor Part2 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> PromptProcessor_Part2:
        return PromptProcessor_Part2(get_cached_asset(part=2, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_embed_tokens_Gather_Gather_output_0": ((1, 128, 3072), "uint16"),
            ...
            "position_ids_cos": ((1, 1, 128, 48), "uint16"),
            "position_ids_sin": ((1, 1, 128, 48), "uint16"),
...
class PromptProcessor_Part3(BasePrecompiledModel):
    """
    Prompt Processor Part3 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> PromptProcessor_Part3:
        return PromptProcessor_Part3(get_cached_asset(part=3, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_layers_7_Add_1_Add_output_0": ((1, 128, 3072), "uint16"),
...
class PromptProcessor_Part4(BasePrecompiledModel):
    """
    Prompt Processor Part4 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> PromptProcessor_Part4:
        return PromptProcessor_Part4(get_cached_asset(part=4, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_layers_15_Add_1_Add_output_0": ((1, 128, 3072), "uint16"),
    ...
    @staticmethod
    def get_output_names() -> list[str]:
        return get_kv_cache_names(start=16, end=24) + ["logits"]
...
class TokenGenerator_Part1(BasePrecompiledModel):
    """
    Token Generator Part1 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> TokenGenerator_Part1:
        return TokenGenerator_Part1(get_cached_asset(part=1, device_name=device_name))
...
class TokenGenerator_Part2(BasePrecompiledModel):
    """
    Token Generator Part2 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> TokenGenerator_Part2:
        return TokenGenerator_Part2(get_cached_asset(part=2, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_embed_tokens_Gather_Gather_output_0": ((1, 1, 3072), "uint16"),
            ...
            "position_ids_cos": ((1, 1, 1, 48), "uint16"),
            "position_ids_sin": ((1, 1, 1, 48), "uint16"),
...
class TokenGenerator_Part3(BasePrecompiledModel):
    """
    Token Generator Part3 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> TokenGenerator_Part3:
        return TokenGenerator_Part3(get_cached_asset(part=3, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_layers_7_Add_1_Add_output_0": ((1, 1, 3072), "uint16"),
...
class TokenGenerator_Part4(BasePrecompiledModel):
    """
    Token Generator Part4 for Phi-3.5-mini-instruct.
    ...
    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> TokenGenerator_Part4:
        return TokenGenerator_Part4(get_cached_asset(part=4, device_name=device_name))

    @staticmethod
    def get_input_spec() -> InputSpec:
        return {
            "_model_layers_15_Add_1_Add_output_0": ((1, 1, 3072), "uint16"),
...
class Phi_3_5_Mini_Instruct(PrecompiledCollectionModel):
    """
    Phi_3_5_Mini_Instruct class consists of
         - Prompt Processor (split into 4 parts)
         - Token Generator (split into 4 parts)

     All models are pre-trained, quantized (w4a16 + w8a16 weight, float32 activations)
     and compiled into serialized binary for Qualcomm devices.
    """

    @classmethod
    def from_precompiled(cls, device_name: str = "snapdragon_8_elite") -> Phi_3_5_Mini_Instruct:
        """
        Creates model from precompiled assets for specified device.
        """
        components = []
        for component_cls in cls.component_classes:
            components.append(component_cls.from_precompiled(device_name=device_name))
